...
public class TC_MMM_3170 extends KeywordUtil {
	...
	@Test
	public void test_TC_MMM_3170() throws Exception {
		...
		try {
			...
			executeStep(isWebElementPresent(Constants.services.all_procedure_select, Common.type_xpath), getClass(),"Verify that all procedure drop down is present");
			...
			executionDelay(2000);
			executeStep(isWebElementPresent(Constants.services.a0021_instant_search, Common.type_xpath), getClass(),"Verify that instant search is present");
			executeStep(click(services.hdrProcedure, Common.type_xpath), getClass(),"Click on Procedure header");
			executionDelay(3000);
			executeStep(isWebElementNotPresent(Constants.services.a0021_instant_search, Common.type_xpath), getClass(),"Verify that instant search is not present");
